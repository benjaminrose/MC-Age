...
# -*- coding: utf-8 -*-
#
# fsps-age documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'fsps-age.tex', 'fsps-age Documentation',
     'Benjamin Rose', 'manual'),
]
...
man_pages = [
    (master_doc, 'fsps-age', 'fsps-age Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fsps-age', 'fsps-age Documentation',
     author, 'fsps-age', 'One line description of project.',
     'Miscellaneous'),
]
